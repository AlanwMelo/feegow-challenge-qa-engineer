...
Agendar Consulta
    ...
    ${unidade}                         Valor Aleatorio De Lista    xpath=//div[contains(@class, 'item-list-unidade')]    data-name
    ...
    ${dia_disponivel}                  Valor Aleatorio De Lista    xpath=//div[@class='content-dia-horario']    data-date
    # Recebe uma horario entre os horarios disponiveis
    ${agendamento}                     Valor Aleatorio De Lista    xpath=//div[contains(@data-date, "${dia_disponivel}")]/div[2]/div/div/ul/li/div//button[contains(@class, "btn hora-item")]    data-time
